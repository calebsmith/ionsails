...
(defn build-initial-system
  ...
  (let [sys (ent/create-system)
        ...
        [sys item] (e/create-item sys "monkey wrench" ["wrench" "monkey"] "A monkey wrench" false)
        [sys item2] (e/create-item sys "monkey wrench" ["wrench" "monkey"] "A monkey wrench" false)
        [sys item3] (e/create-item sys "an adjustable wrench" ["wrench" "adjustable"] "An adjustable wrench" false)
        [sys item4] (e/create-item sys "scrap metal" ["scrap" "metal"] "pieces of scrap metal" false)
        [sys item5] (e/create-item sys "vat-grown meat jerky" ["meat" "jerky" "vat"] "A piece of vat grown meat jerky" false)
        [sys pack] (e/create-item sys "backpack" ["backpack"] "A burlap backpack" true)
